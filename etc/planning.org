...
Bill and I have been chatting, and we're thinking trying to submit a paper on the PDF Trust Chain for Langsec 2022 http://langsec.org/spw22/.
The deadline is Feb 7, 2021 (3 weeks from now).
I'm not sure how much time and level of contribution you're open for ... but I was thinking we three could get together to see where we're all at, would you be available for a meeting this week?
What about this Wed. 3PM PST (the time we usually use for the Trust Chain mtg)?

** DONE [#A] first draft of outline 
...
** TODO [#A] get format, outline into the document
...
** TODO overleaf
- setup with github?
** TODO get initial template into document
...
#+begin_src haskell
  ...
  {- for trad offsets: parse the top level defns, stop at "stream" -}
  ...
  {- lookup (and parse) compressed objects: -}
...
* TODO [#A] exploring topic/thesis/slant
