% walk through the format definition in technical detail:
...
%
\Cref{sec:results-analysis} analyses the resulting specification.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Requirements of a Specification}
...
\begin{itemize}
  ...
  \item Because Haskell is purely functional, we have a simple monad
...
that are ``reasonably small'' \todo{is this a quote?}.
%
