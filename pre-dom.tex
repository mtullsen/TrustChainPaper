...
\item The standard defines one thing: \emph{What is a valid PDF?},
  ...
  (5) If given an incorrect PDF, is the behavior undefined\footnote{
    ...
    \mtnote{this last, (5), seems pretty key and
      feels like a major omission in the standard! This question
      brings us to the ``[e]ndobj'' cavity thing!}
\end{itemize}
...
We are transforming \lstcd{xrefs0} into \lstcd{xrefs1}, note the types:
\begin{codeNoExecute}
...
% this gets to be complicated/tedious!
