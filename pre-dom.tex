...
%
In our work specifically, the parser monad \lstcd{P} abstracts effects on a parser's state.
%
Its state includes %
...
\end{codeNoExecute}
\haskellnote{
The infix type operator \lstcd{a :+: b} is a synonym for the Haskell sum type \lstcd{Either a b}, which has constructors
