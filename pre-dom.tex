...
\end{code}
\lstdcode{mergeUpdate} uses the functions
\begin{code}
...
For simplicity, the definition does not constraint \objids{} using  trailer dictionaries' \lstcd{Size} key;
%
the standard requires that:

to constrain \objids{}.
%
Note these comments about \lstcd{Size} from the standard:
\begin{itemize}
...
Not only is this stage already complex, but there are multiple feasible variations of \lstcd{mergeUpdate}, with distinct semantics:
\begin{itemize}
