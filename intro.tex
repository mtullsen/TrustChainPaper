...
%
\textbf{(2)} the reference structure is compressed, via standardized
...
using separated context, via \emph{linearization}. The parsing
of this reference and context information
occurs before DOM creation and DOM object validation, introducing a
reliance on the correctness of all \emph{pre-DOM} processing.
