...
%
The induces \emph{ambiguities}, which causes different parties
...
additional exploits based on incremental updates (CVE-2022-25641).  
%
...
follows;
%
\Cref{sec:trust-chain} presents the ``PDF Trust Chain,'' a key metaphor
