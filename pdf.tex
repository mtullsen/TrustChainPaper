...
susceptible to ``ZIP bomb'' \todo{explain!} attacks and handling of semantic errors (invalid stream extent dictionaries) 
...
The above paragraphs describe the physical structure of a PDF file, but the processing sequence may not be so apparent. 
...
\todob{put small example here or ...?}
...
\begin{itemize}
    ...
    \item incorrect trailer dictionary data (such as \lstcd{Size}), leading implementation-dependent decisions;  
