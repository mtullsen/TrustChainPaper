...
\begin{abstract}
  ...
  \pwnote{shouldn't this be "references to data objects"?}.
  %
  ...
  \pwnote{Sorry - I don't understand this previous sentence. How about "The integrity of these references and their context ensures that an ambiguous DOM graph is established from a basis of trust."?}
