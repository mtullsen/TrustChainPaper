...
\label{sec:org5ebe766}
\begin{frame}[label={sec:org9db55db}]{PDF Complexity?}
\begin{center}
 { \hspace{5pt}
...
\begin{frame}[label={sec:orga37e513}]{Parser NEQ Validator}
...
\begin{frame}[label={sec:org4613b39},fragile]{One Solution \ldots{}}
 \begin{itemize}
...
\begin{frame}[label={sec:orgda8222a},fragile]{Better Solution, Parser as API}
