...
\label{sec:org7fec4ff}
\begin{frame}[label={sec:orgfb9052d}]{PDF Complexity?}
\begin{center}
 { \hspace{5pt}
...
\begin{frame}[label={sec:orgf0183d4}]{PDF Trust Chain: Pre-DOM and Post-DOM}
\begin{center}
\includegraphics[width=0.63\linewidth]{images/trustchain-with-braces.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org10dc1ed}]{Vulnerabilities Occurring Primarily Pre-DOM}
\begin{itemize}
