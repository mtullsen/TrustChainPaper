...
{\bf{Steganography}} \todo{do we really want to discuss ways of hiding data in PDF? Or is this just more noting that the pre-DOM data could be used to hide data as well?}
